    ...
    <div className="flex flex-col w-full bg-white">
      ...
      <section className="relative overflow-hidden py-20 px-6 sm:px-8 border-b border-[#7fc3cb] bg-[#96DAE2] text-center">
        ...
        <div className="relative z-10 mx-auto max-w-[1280px]">
          <span className="text-[12px] uppercase font-bold tracking-wider text-[#0a0a0a]">Simple Pricing</span>
      ...
      <section className="bg-white py-16 sm:py-24 px-6 sm:px-8 border-t border-[#eaecf0]">
        <div className="mx-auto max-w-[960px]">
          <div className="text-center mb-12">
            ...
            <h2 className="text-[28px] sm:text-[36px] font-bold text-[#0a0a0a] mt-2">Frequently Asked Questions</h2>
          ...
          <div className="mt-16 pt-12 border-t border-[#e5e7eb] text-center">
            <h3 className="text-[18px] font-bold text-[#0a0a0a] mb-3">Still have questions?</h3>
