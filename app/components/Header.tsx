        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <div className="relative" ref={compareRef}>
              ...
              >
                Compare
                <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${compareOpen ? 'rotate-180' : ''}`} />
              </button>
              ...
              {compareOpen && (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">AI reasoning vs. legacy flow builder</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">Autonomous support vs. expensive seats</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">Advanced reasoning vs. basic bot filters</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">Omni-channel agents vs. ticket ticketing</span>
                  </Link>
                </div>
              )}
            </div>
              ...
              {companyOpen && (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">Our Mission & Vision</span>
                  </Link>
                  <Link
                    href="/company#blog"
                    onClick={() => setCompanyOpen(false)}
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">Product updates & AI insights</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">Join the engineering team</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className="text-[12px] text-[#8e8e93]">Support & Sales inquiries</span>
                  </Link>
                </div>
              )}
            </div>
        ...
        <div className="lg:hidden border-t border-[#eaecf0] bg-white px-6 py-6 shadow-md absolute w-full left-0 transition-all duration-200">
          <nav className="flex flex-col gap-4">
            ...
            <div className="py-2 border-b border-[#f2f3f5]">
              <span className="text-[12px] font-semibold text-[#8e8e93] uppercase tracking-wider">Compare</span>
              <div className="mt-2 pl-4 flex flex-col gap-3">
                <Link href="/compare?vs=manychat" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">vs. ManyChat</Link>
                <Link href="/compare?vs=intercom" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">vs. Intercom</Link>
                <Link href="/compare?vs=tidio" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">vs. Tidio</Link>
                <Link href="/compare?vs=gorgias" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">vs. Gorgias</Link>
              </div>
            </div>

            <div className="py-2 border-b border-[#f2f3f5]">
              <span className="text-[12px] font-semibold text-[#8e8e93] uppercase tracking-wider">Company</span>
              <div className="mt-2 pl-4 flex flex-col gap-3">
                <Link href="/company#about" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">About Us</Link>
                <Link href="/company#blog" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">Blog</Link>
                <Link href="/company#careers" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">Careers</Link>
                <Link href="/company#contact" onClick={() => setMobileMenuOpen(false)} className="text-[15px] text-[#45515e]">Contact Us</Link>
              </div>
            </div>
