...
export default function CompanyPage() {
  ...
  return (
    <div className='flex flex-col w-full bg-white'>
      ...
      <section
        id='about'
        className='py-20 px-6 sm:px-8 border-b border-[#eaecf0] bg-white scroll-mt-16'
      >
        <div className='mx-auto max-w-[960px] text-center'>
          <span className='text-[12px] uppercase font-bold tracking-wider text-[#ff5530]'>
            Our Purpose
          </span>
          ...
          <blockquote className='mt-8 text-[28px] sm:text-[36px] lg:text-[40px] font-semibold text-[#0a0a0a] leading-snug tracking-tight text-center max-w-4xl mx-auto italic'>
            &ldquo;We build autonomous systems to solve repetitive customer
            operations, liberating human ingenuity to focus on creative,
            high-impact challenges.&rdquo;
          </blockquote>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <article className='bg-white border border-[#e5e7eb] rounded-xl overflow-hidden flex flex-col justify-between hover:shadow-sm transition-shadow duration-200'>
              <div className='p-6 flex flex-col gap-5'>
                ...
                <h3 className='text-[18px] font-bold text-[#0a0a0a] leading-tight'>
                  Training Large Language Models for Zero-Shot Conversational
                  Deflection
                </h3>
                <p className='text-[13px] text-[#5f5f5f] leading-relaxed'>
                  How we configure our custom embedding models to ingest
                  technical support manuals and resolve refund logic without
                  manual fine-tuning.
                </p>
              </div>
            ...
            <article className='bg-white border border-[#e5e7eb] rounded-xl overflow-hidden flex flex-col justify-between hover:shadow-sm transition-shadow duration-200'>
              <div className='p-6 flex flex-col gap-5'>
                ...
                <p className='text-[13px] text-[#5f5f5f] leading-relaxed'>
                  Introducing our core updates: dynamic tool calling parameters,
                  instant sync vectors, and official WhatsApp Business API
                  endpoints.
                </p>
              </div>
              <div className='border-t border-[#f2f3f5] p-6 flex justify-between items-center text-[12px] text-[#8e8e93]'>
            ...
            <article className='bg-white border border-[#e5e7eb] rounded-xl overflow-hidden flex flex-col justify-between hover:shadow-sm transition-shadow duration-200'>
              <div className='p-6 flex flex-col gap-5'>
                ...
                <h3 className='text-[18px] font-bold text-[#0a0a0a] leading-tight'>
                  How Retailing Group Deflected 52% of Support Tickets in 14
                  Days
                </h3>
                <p className='text-[13px] text-[#5f5f5f] leading-relaxed'>
                  A case study detailing the deployment of Lashvae AI Web Chat
                  widget and Shopify API connections across a 15-brand retail
                  portfolio.
                </p>
              </div>
              <div className='border-t border-[#f2f3f5] p-6 flex justify-between items-center text-[12px] text-[#8e8e93]'>
      ...
      <section
        id='careers'
        className='py-16 sm:py-24 px-6 sm:px-8 bg-white border-b border-[#eaecf0] scroll-mt-16'
      >
        <div className='mx-auto max-w-[1280px]'>
          <div className='mb-12 max-w-2xl text-left'>
            ...
            <h2 className='heading-md-typography mt-2 text-[#0a0a0a]'>
              Open Engineering & Product Roles
            </h2>
            <p className='text-[#5f5f5f] mt-3'>
              We are looking for builders who want to re-architect global
              support pipelines.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-start'>
            ...
            <div className='lg:col-span-5 text-left space-y-6'>
              <div>
                ...
                <p className='text-[#5f5f5f] mt-3'>
                  Have questions about custom SLAs, high-volume pricing, or
                  training vectors? Our enterprise sales team is here to help.
                </p>
              </div>
