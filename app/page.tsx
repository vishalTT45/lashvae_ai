        ...
        <div className='mx-auto max-w-[1280px] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='flex flex-col items-start text-left'>
            ...
            <p className='mt-6 text-[17px] sm:text-[19px] text-[#45515e] max-w-lg leading-relaxed'>
              Lashvae unifies all your customer messages across platforms and
              responds with emotionally intelligent AI that truly understands
              their needs.
            </p>
        ...
        <div className='mx-auto max-w-[1280px]'>
          <div className='text-center max-w-2xl mx-auto mb-14'>
            <h2 className='heading-md-typography mt-2 text-[#0a0a0a]'>
              Built for revenue. Not just replies.
            </h2>
            <p className='text-[#45515e] mt-3 text-[15px]'>
              Every capability designed around one outcome: turning customer
              messages into closed deals.
            </p>
          </div>
        ...
        <div className='mx-auto max-w-[1280px]'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <h2 className='heading-md-typography mt-2 text-[#0a0a0a]'>
                The deal goes to whoever replies first.
              </h2>
              <div className='mt-6 space-y-6'>
                <div className='bg-[#fff1ee] border border-[#ff5530]/20 rounded-xl p-5'>
                  <div className='text-[11px] font-bold tracking-wider uppercase text-[#ff5530] mb-2'>
                    The Problem
                  </div>
                  <p className='text-[14px] text-[#222222] leading-relaxed'>
                    Leads DM your page. Your team replies 38 minutes later.
                    They&apos;ve already bought from someone else.
                  </p>
                </div>
                <div className='bg-[#eef2ff] border border-[#1456f0]/20 rounded-xl p-5'>
                  <div className='text-[11px] font-bold tracking-wider uppercase text-[#1456f0] mb-2'>
                    The Solution
                  </div>
                  <p className='text-[14px] text-[#222222] leading-relaxed'>
                    Lashvae reads the message and replies in ~3 seconds —
                    qualifying the lead, answering their question, and booking
                    the call.
                  </p>
                </div>
                <div className='bg-[#e8ffea] border border-[#1ba673]/20 rounded-xl p-5'>
                  <div className='text-[11px] font-bold tracking-wider uppercase text-[#1ba673] mb-2'>
                    The Outcome
                  </div>
                  <p className='text-[14px] text-[#222222] leading-relaxed'>
                    94% more leads convert. Every hour of every day. Without
                    adding headcount.
                  </p>
                </div>
              </div>
            ...
            <div className='bg-[#0a0a0a] rounded-2xl p-8 text-white space-y-6'>
              <div className='text-[13px] text-[#a8aab2] font-mono uppercase tracking-wider'>
                Lashvae vs. Manual Support
              </div>
              {[
                {
                ...
                <div
                  key={row.label}
                  className='grid grid-cols-3 gap-2 border-b border-[#181e25] pb-4 last:border-0 last:pb-0 text-[13px]'
                >
                  <span className='text-[#a8aab2]'>{row.label}</span>
                  <span className='text-[#5f5f5f] line-through text-center'>
                    {row.them}
                  </span>
                  <span className='text-[#1ba673] font-bold text-right'>
                    {row.us}
                  </span>
                </div>
              ))}
            ...
            <div className='relative z-10 max-w-xl mx-auto flex flex-col items-center'>
              ...
              <div className='mt-8 flex flex-col sm:flex-row gap-4 w-full justify-center max-w-md'>
                ...
                <Link
                  ...
                  className='rounded-full border border-white/20 bg-white/10 text-white px-8 py-3.5 font-semibold text-[14px] hover:bg-white/20 text-center'
                >
                  Talk to Sales
                </Link>
              </div>
